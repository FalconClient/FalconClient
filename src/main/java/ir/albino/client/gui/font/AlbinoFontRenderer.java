...
public class AlbinoFontRenderer extends CFont {

    protected CFont.CharData[] boldChars = new CFont.CharData[maxChars];
    protected CFont.CharData[] italicChars = new CFont.CharData[maxChars];
    protected CFont.CharData[] boldItalicChars = new CFont.CharData[maxChars];
    public int FONT_HEIGHT = fontHeight;
    private final int[] colorCode = new int[32];

    /*
        CREDIT G0dwhitelight.
     */
    public AlbinoFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics) {
        super(font, antiAlias, fractionalMetrics);
        setupMinecraftColorcodes();
        setupBoldItalicIDs();
    }

    public AlbinoFontRenderer(String NameFontTTF, int size, int fonttype, boolean antiAlias, boolean fractionalMetrics) {
