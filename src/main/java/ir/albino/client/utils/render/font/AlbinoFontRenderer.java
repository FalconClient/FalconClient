...
import ir.albino.client.utils.render.font.CFont;
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (String.valueOf(character).equals("\247")) {
                ...
                if (strikethrough) {
                    drawLine(x, y + (double) currentData[character].height / 2, x + currentData[character].width - horizontalSpacing, y + (double) currentData[character].height / 2, 1.0F);
                }
