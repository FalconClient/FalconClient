...
public class AltManagerMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        } else this.altList.setDimensions(this.width, this.height, 32, this.height - 64);
    ...
    public void createButtons() {
        buttonList.addAll(Arrays.asList(
                new GuiButton(0, this.width - 110, height - 55, 100, 20, I18n.format("altmanager.add")),
                btnRemove = new GuiButton(1, this.width - 110, height - 30, 100, 20, I18n.format("altmanager.remove")),
                new GuiButton(2, 10, height - 30, 100, 20, I18n.format("gui.done"))
        ));
    }
