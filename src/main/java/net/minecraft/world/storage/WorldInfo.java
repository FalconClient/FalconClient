...
public class WorldInfo {
    ...
    public WorldInfo(NBTTagCompound nbt) {
        ...
        setRaining(nbt.getBoolean("raining"));
        this.thunderTime = nbt.getInteger("thunderTime");
        setThundering(nbt.getBoolean("thundering"));
    ...
    public WorldInfo(WorldInfo worldInformation) {
        ...
        this.setRaining(worldInformation.raining);
        this.thunderTime = worldInformation.thunderTime;
        this.setThundering(worldInformation.thundering);
    ...
    public void setThundering(boolean thunderingIn) {
        WeatherChangeEvent event = new WeatherChangeEvent(thunderingIn ? Weather.THUNDER : Weather.CLEAR);
        AlbinoClient.instance.eventManager.post(event);
        if (event.isCancelled()) {
            this.thundering = !thunderingIn;
        } else this.thundering = thunderingIn;
    ...
    public void setRaining(boolean isRaining) {
        WeatherChangeEvent event = new WeatherChangeEvent(isRaining ? Weather.RAIN : Weather.CLEAR);
        AlbinoClient.instance.eventManager.post(event);
        if (event.isCancelled()) {
            this.raining = !isRaining;
        } else this.raining = isRaining;
    }
