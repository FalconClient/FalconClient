...
public class IntegratedServer extends MinecraftServer
{
    ...
    public IntegratedServer(final Minecraft mcIn, final String folderName, final String worldName, final WorldSettings settings)
    {
        ...
        if (worldinfo != null && nbttagcompound != null && nbttagcompound.hasKey("Dimension"))
        {
    ...
    protected void loadAllWorlds(final String saveName, final String worldNameIn, final long seed, final WorldType type, final String worldNameIn2)
    {
        ...
        {
            final WorldServer worldserver = this.isDemo() ? (WorldServer) (new DemoWorldServer(this, isavehandler, worldinfo, 0, this.theProfiler)).init() : (WorldServer)(new WorldServer(this, isavehandler, worldinfo, 0, this.theProfiler)).init();
            worldserver.initialize(this.theWorldSettings);
            final Integer[] ainteger = (Integer[]) Reflector.call(Reflector.DimensionManager_getStaticDimensionIDs, new Object[0]);
