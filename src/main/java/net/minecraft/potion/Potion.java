...
public class Potion {
    ...
    private static final Map<ResourceLocation, Potion> potionMap = Maps.newHashMap();
    ...
    public static Potion getPotionFromResourceLocation(String location) {
        return potionMap.get(new ResourceLocation(location));
    }

    public static Set<ResourceLocation> getPotionLocations() {
        return potionMap.keySet();
    }
