...
public class MusicTicker implements ITickable {
    ...
    public void update() {
        ...
        if (this.currentMusic == null && this.timeUntilNextMusic-- <= 0) {
            this.playNextMusic(musicticker$musictype);
        }
    }

    public void playNextMusic(MusicTicker.MusicType type) {
        this.currentMusic = PositionedSoundRecord.create(type.musicLocation);
        this.mc.getSoundHandler().playSound(currentMusic);
