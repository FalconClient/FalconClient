        ...
        for (final SoundList.SoundEntry entry : sounds.getSoundList()) {
            ...
            switch (entry.getSoundEntryType()) {
                case FILE:
                    ...
                    isoundeventaccessor = new SoundEventAccessor(new SoundPoolEntry(resourcelocation1, (double) entry.getSoundEntryPitch(), entry.getSoundEntryVolume(), entry.isStreaming()), entry.getSoundEntryWeight());
                    break;
