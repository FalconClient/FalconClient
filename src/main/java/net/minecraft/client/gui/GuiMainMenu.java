...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public GuiMainMenu() {
        ...
        fontRenderer = Minecraft.getMinecraft().client.fontRenderer;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        backgroundTexture = new ResourceLocation("textures/gui/title/background.png");
        GlStateManager.disableAlpha();
        ...
        if (this.openGLWarning1 != null && this.openGLWarning1.length() > 0) {
            ...
            this.drawString(this.fontRenderer, this.openGLWarning2, (this.width - this.field_92024_r) / 2, ((GuiButton) this.buttonList.get(0)).yPosition - 12, -1);
        }
    ...
    private void drawBackground() {
        ...
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
        worldrenderer.pos(-1.0D, -1.0D, 1.0D).tex(0.0D, 0.0D).color(255, 255, 255, 0).endVertex();
        worldrenderer.pos(1.0D, -1.0D, 1.0D).tex(1.0D, 0.0D).color(255, 255, 255, 0).endVertex();
        worldrenderer.pos(1.0D, 1.0D, 1.0D).tex(1.0D, 1.0D).color(255, 255, 255, 0).endVertex();
        worldrenderer.pos(-1.0D, 1.0D, 1.0D).tex(0.0D, 1.0D).color(255, 255, 255, 0).endVertex();
        tessellator.draw();
        GlStateManager.popMatrix();
        GlStateManager.colorMask(true, true, true, false);
        GlStateManager.matrixMode(5889);
