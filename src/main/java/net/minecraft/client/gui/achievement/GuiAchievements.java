    ...
    protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
        ...
        if (achievement != null) {
            ...
            if (this.statFileWriter.canUnlockAchievement(achievement)) {
                ...
                this.mc.fontRendererObj.drawSplitString(s1, i7, k7 + 12, j8, -6250336);
                ...
                this.mc.fontRendererObj.drawSplitString(s2, i7, k7 + 12, k8, -9416624);
            } else if (i8 < 3) {
                ...
                this.mc.fontRendererObj.drawSplitString(s3, i7, k7 + 12, l8, -9416624);
            } else {
                s = null;
            }
