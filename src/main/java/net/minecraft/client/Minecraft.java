...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.client.initializeFontRenderer();
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = getClass().getClassLoader().getResourceAsStream("assets/minecraft/icons/icon16.png");
                inputstream1 = getClass().getClassLoader().getResourceAsStream("assets/minecraft/icons/icon32.png");
                assert inputstream != null;
                assert inputstream1 != null;
                BufferedImage image16 = ImageIO.read(inputstream);
                BufferedImage image32 = ImageIO.read(inputstream1);
                Display.setIcon(new ByteBuffer[]{new ImageIOImageData().imageToByteBuffer(image16, false, false, null),
                        new ImageIOImageData().imageToByteBuffer(image32, false, false, null)});
